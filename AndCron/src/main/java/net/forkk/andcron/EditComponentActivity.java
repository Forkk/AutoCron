...
{
    public static final String EXTRA_COMPONENT_ID = "net.forkk.andcron.component_id";

    public static final String EXTRA_COMPONENT_TYPE = "net.forkk.andcron.component_type";
